...
cat /home/xxxusernamexxx/install/configs/programs/Headphones.txt > /opt/headphones/config.ini

sudo chown -R headphones:headphones /opt/headphones
sudo chmod -R 0777 /opt/headphones

echo "Creating Startup Script"
cp /home/xxxusernamexxx/install/Services/headphones.service /etc/systemd/system/
